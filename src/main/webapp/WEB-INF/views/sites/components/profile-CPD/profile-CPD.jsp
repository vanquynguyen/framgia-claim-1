                            ...
                            <div class="cmsmasters_tabs tabs_mode_tab cmsmasters_tabs_resp">
                                ...
                                <div class="cmsmasters_tabs_wrap">
                                    ...
                                    <div id="cmsmasters_tab_ke2aka5gfc" class="cmsmasters_tab">
                                        <div class="cmsmasters_tab_inner">
                                            <div class="cmsmasters_img  cmsmasters_image_l"><img src='<c:url value="/resources/sites/uploads/2015/11/home-3-1.jpg"/>' alt="tab-3" /></div>
                                            <div id="cmsmasters_fb_yy5qcoh0vc" class="cmsmasters_featured_block">
                                                <div class="featured_block_inner">
                                                    <div class="featured_block_text">
                                                        <div id="cmsmasters_heading_atcjur22c5" class="cmsmasters_heading_wrap cmsmasters_heading_align_left">
                                                            <h2 class="cmsmasters_heading">Transforming the way you pay. Explore new ways to pay</h2>
                                                        </div>
                                                        <div id="cmsmasters_heading_s3k0fnj3e" class="cmsmasters_heading_wrap cmsmasters_heading_align_left">
                                                        ...
                                                        <div id="cmsmasters_button_pe91q9a37" class="button_wrap"><a href="services/index.html" class="cmsmasters_button"><span>Learn more</span></a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
